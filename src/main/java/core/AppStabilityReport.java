...
public class AppStabilityReport extends Command {
    ...
    public AppStabilityReport(User user, String username, LocalDate ts) {
        super(user, username, ts, CmdType.appStabilityReport);
    }

    @Override
    public ObjectNode execute(AppSystem system) {
        AppStabilityReportVisitor visitor = new AppStabilityReportVisitor(this);
